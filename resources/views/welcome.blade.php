...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full scroll-smooth" style="background-color: #071a12 !important; background: #071a12 !important; margin: 0; padding: 0;">
    ...
    >
        ...
        <!-- =====================================================
             ...
             ===================================================== -->
        <footer class="relative overflow-hidden font-['DM_Sans',sans-serif]" style=" background: linear-gradient(135deg, #0B1A33, #4e5bff, #0B1A33);">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 pt-16 pb-8">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16">
                    ...
                    <div class="md:col-span-4 space-y-6">
                        ...
                        <a href="/" wire:navigate class="inline-flex items-center gap-3 group" aria-label="FinPulse Home">
                            ...
                            <span class="font-bold text-xl text-white">Fin<span class="text-white">Pulse</span></span>
                        </a>
                        ...
                        <div class="flex items-center gap-4 pt-1">
                            <a href="#" aria-label="Twitter / X" class="text-white hover:text-white transition-colors duration-200">
                            ...
                            <a href="#" aria-label="GitHub" class="text-white hover:text-white transition-colors duration-200">
                            ...
                            <a href="#" aria-label="LinkedIn" class="text-white hover:text-white transition-colors duration-200">
                                <svg class="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                            </a>
                            <a href="#" aria-label="YouTube" class="text-white hover:text-white transition-colors duration-200">
                            ...
                            <a href="#" aria-label="Instagram" class="text-white hover:text-white transition-colors duration-200">
                    ...
                    <div class="md:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-10 lg:gap-16">
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Community Feed</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Stock Research</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Learning Modules</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Market Watchlist</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Blog</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Research Library</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Webinars</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Newsletters</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">About Us</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Careers</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Privacy Policy</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Terms of Service</a></li>
                                <li><a href="#" class="text-sm text-white hover:text-emerald-400 transition-colors duration-200">Contact Us</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-14 pt-7 border-t border-emerald-900/40 flex flex-col sm:flex-row items-center justify-between text-xs text-[#5a6a5e] gap-3">
                    <p class="text-white">&copy; {{ date('Y') }} FinPulse Design</p>
...
<div class="max-w-[100vw] flex items-end justify-center" style="height: 150px;">                    <span class="whitespace-nowrap text-white  text-[min(14vw,160px)] font-black tracking-tight leading-none" style="color: transparent; -webkit-text-stroke: 1.5px rgba(255, 255, 255, 1); text-stroke: 1.5px rgba(255, 255, 255, 1);">
                        FinPulse
                    </span>
                </div>
                <!-- Bottom gradient fade -->
                <div class="relative bottom-0 left-0 right-0 h-12" style="background: linear-gradient(to top, #071a12, transparent);"></div>
            </div>
        </footer>
