<div class="py-8 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 space-y-6 fp-animate-in">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center gap-2 flex-wrap">
                ...
                @if($course->restricted_to_batches)
                    <span class="text-xs font-bold px-2.5 py-1 rounded-full bg-purple-600 text-white uppercase tracking-wider shadow-sm flex items-center gap-1.5">
        ...
        @if(!$canAccess)
            <div class="rounded-2xl p-8 sm:p-10 text-center text-white border shadow-xl relative overflow-hidden my-4 fp-animate-in"
