<div class="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
    ...
    <div class="text-center max-w-3xl mx-auto space-y-3 fp-animate-in">
        ...
        <p class="text-base sm:text-lg text-finpulse-gray">Explore free financial education articles, video guides, and
            foundational tutorials designed to empower your financial journey.</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 space-y-4 fp-animate-in">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                <label for="search"
                    class="block text-xs font-semibold text-finpulse-gray uppercase tracking-wider mb-1">Search</label>
                <div class="relative">
                    <input id="search" type="text" wire:model.live.debounce.300ms="search" placeholder="Search title..."
            ...
            <div>
                <label for="type"
                    class="block text-xs font-semibold text-finpulse-gray uppercase tracking-wider mb-1">Type</label>
            ...
            <div>
                <label for="skillLevel"
                    class="block text-xs font-semibold text-finpulse-gray uppercase tracking-wider mb-1">Skill
                    Level</label>
            ...
            <div>
                <label for="language"
                    class="block text-xs font-semibold text-finpulse-gray uppercase tracking-wider mb-1">Language</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 fp-stagger-grid">
        @forelse($items as $item)
            ...
            @endphp
            <div
                class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col justify-between group fp-card-hover space-y-4">
                <div class="space-y-3">
                    <!-- Badges Row -->
                    <div class="flex items-center justify-between gap-2 flex-wrap">
                        ...
                        <span
                            class="text-xs font-semibold px-2.5 py-1 rounded-full bg-finpulse-cream text-finpulse-navy border border-amber-200 uppercase tracking-wider">
                    ...
                    <!-- Title -->
                    <h2
                        class="text-lg font-bold text-finpulse-navy group-hover:text-[#C89B3C] transition-colors duration-200 line-clamp-2">
        ...
        @empty
            <div class="col-span-full bg-white rounded-xl p-12 text-center border border-gray-200 space-y-3 fp-animate-in">
                ...
                <p class="text-sm text-gray-500 max-w-md mx-auto">No free content items match your selected filter criteria.
                    Try resetting filters or adjusting search terms.</p>
                @if($type !== 'all' || $skillLevel !== 'all' || $language !== 'all' || $search !== '')
                    <div class="pt-2">
                        <button type="button" wire:click="resetFilters"
